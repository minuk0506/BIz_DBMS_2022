...
/*
tbl_score 데이터는 한 학생의 과목점수가 각각 레코드별로 저장 되어있다.
...
필요에 따라 Super Key 로 PK 를 설정 하기도 하지만 Super Key 는 잘못 사용하면
데이터 무결성을 해칠 수 있다.
...
-- 학번 S0044 인 학생의 미술점수를 50 점에서 80 점으로 바꾸고 싶다
...
-- 성적 조회를 하였는데 학번과 점수만 나타나서 누구인지 알 수가 없다.
